...
public class Quest : MonoBehaviour
{
    ...
    public void QuestList()                                     //퀘스트의 정보
    {
        ...
        questInfoList.Add(new QuestInfo(1, 1, 1, QuestState.Success, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요2", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
        questInfoList.Add(new QuestInfo(2, 2, 2, QuestState.Enable, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~3", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
        questInfoList.Add(new QuestInfo(3, 1, 3, QuestState.Access, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~4", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
        questInfoList.Add(new QuestInfo(4, 2, 1, QuestState.Able, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~5", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
        questInfoList.Add(new QuestInfo(5, 2, 1, QuestState.Success, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~6", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
        questInfoList.Add(new QuestInfo(6, 1, 2, QuestState.Enable, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~7", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
        questInfoList.Add(new QuestInfo(7, 1, 3, QuestState.Enable, QuestType.Type_Kill, MonsterCode.WM101, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~8", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!", 0));
