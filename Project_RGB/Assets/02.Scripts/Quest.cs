...
public class Quest : MonoBehaviour
{
    ...
    public void QuestList()
    {
        ...
        questInfoList.Add(new QuestInfo(1, 1, 1, QuestState.Success, QuestType.Type_Kill, MonsterCode.FM201, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~2", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!",0));
        questInfoList.Add(new QuestInfo(2, 1, 2, QuestState.Success, QuestType.Type_Kill, MonsterCode.FM201, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~3", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!",0));
        ...
        questInfoList.Add(new QuestInfo(4, 1, 1, QuestState.Enable, QuestType.Type_Kill, MonsterCode.FM201, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~5", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!",0));
        questInfoList.Add(new QuestInfo(5, 1, 1, QuestState.Able, QuestType.Type_Kill, MonsterCode.FM201, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~6", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!",0));
        questInfoList.Add(new QuestInfo(6, 1, 2, QuestState.Able, QuestType.Type_Kill, MonsterCode.FM201, 5, QuestRewardCode.Equipment, 5, "열매 요리가 하고 싶어요~7", "길고양이가 갑자기 길목을 막아서더니 바닥에 참치 그림을 그렸다. 불타는 용암 폭포에서 불타는 참치를 구해다 주자.", "7000Gold 기부", "허허허! 자네 더 좋은 무기가 가지고 싶지 않으가!? 좋은 철을 가져오면 내 하나 만들어줌세!!",0));
